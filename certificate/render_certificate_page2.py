"""
Standalone render script for Certificate Page 2
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        try:
            ...
            print("Usage: python render_certificate_page2.py <inward_id> [api_url]")
            sys.exit(1)
    else:
    ...
    # Render and save
    output_file = 'certificate_page2_rendered.html'
    render_certificate_page2(data, output_path=output_file)
    
    print(f"Rendered certificate page 2 -> {output_file}")
